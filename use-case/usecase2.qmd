...
Ce tutoriel vise à illustrer un cas d'usage classique de `cartiflette` : __récupérer de manière flexible un fonds de carte dont les [DROM sont rapprochés]{.yellow} et où [un deuxième]{.yellow}__.  

Ce besoin classique est illustré en répliquant la carte faite par [Jules Grandin "Plus de vaches ou d'habitants"](https://x.com/JulesGrandin/status/1531631375505399809?mx=2)
...
title = {
    "Bovins": "Plus de vaches 🐮 ou d'habitants ?",
    "Porcins": "Plus de cochons 🐷 ou d'habitants ?",
    "Ovins": "Plus de chèvres 🐐 ou d'habitants ?"
}
