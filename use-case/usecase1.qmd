...
# 2. Départements 
departements = contours_villes_arrt.dissolve("INSEE_DEP") #<2>
```
...
2. La construction du fonds de carte `departements` se fait simplement avec la méthode `dissolve`. Il nous sera utile pour contextualiser la carte. 
